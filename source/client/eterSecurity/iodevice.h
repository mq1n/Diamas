...
public:
	...
	/// \brief Writes an uint32_t 64 bit integer to output source.
	///
	/// \param data Integer to write
	...
	/// \brief Writes an uint32_t 32 bit integer to output source.
	///
	/// \param data Integer to write
	...
	/// \brief Writes an uint32_t 16 bit integer to output source.
	///
	/// \param data Integer to write
	...
	/// \brief Writes an uint32_t 8 bit integer to output source.
	///
	/// \param data Integer to write
	...
	/// \brief Reads an uint32_t 64 bit integer from input source.
	/** \return The integer read.*/
	...
	/// \brief Reads an uint32_t 32 bit integer from input source.
	/** \return The integer read.*/
	...
	/// \brief Reads an uint32_t 16 bit integer from input source.
	/** \return The integer read.*/
	...
	/// \brief Reads an uint32_t 8 bit integer from input source.
	/** \return The integer read.*/
	uint8_t read_uint8();
	...
	///
	/// \param skip_initial_chars Ignore any of these characters at the start of the string. nullptr = Do not ignore any characters
	/// \param read_until_chars Read from the input until any of these characters are found. nullptr = Read until the end of the file
