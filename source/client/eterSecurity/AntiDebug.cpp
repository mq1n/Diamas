...
void CAnticheatManager::CheckExceptionTrap()
{
	auto trapDelay = GetTrapDelay();
	if (trapDelay > 3000)
	{
		CCheatDetectQueueMgr::Instance().AppendDetection(DEBUG_TRAP, trapDelay, "");
		ExitByAnticheat(DEBUG_TRAP, trapDelay);
	}
}
