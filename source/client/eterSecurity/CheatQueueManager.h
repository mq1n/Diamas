...
enum ECheatViolationIDs : uint32_t
{
	...
	PARENT_CHECK_ACCESS_FAIL,					// 50
	PARENT_CHECK_UNKNOWN_EXPLORER,
	PARENT_CHECK_UNKNOWN_PARENT,
	PARENT_CHECK_STARTUP_VIOLATION,
	DEBUG_TRAP,
	UNKNOWN_PYTHON_MODULE,
	SUSPECTED_PYTHON_FILE,
	SUSPECTED_PYTHON_BUILTIN,
	UNALLOWED_PYTHON_API,
	CORRUPTED_WINAPI,
};
...
{
	using TNetworkReportCallback = std::function<bool(const char*, const char*)>;
