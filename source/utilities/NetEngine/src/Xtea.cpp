...
{
    void XTEA::Encrypt(const uint8_t *input, uint8_t *output, std::size_t size, const uint32_t *key, uint32_t numRounds)
    {
    ...
    uint32_t XTEA::Decrypt(const uint8_t *input, uint8_t *output, std::size_t size, const uint32_t *key, uint32_t numRounds)
    {
        std::size_t steps = size / 8;
        std::size_t currentStep = 0;
