...
bool LZOManager::Compress(const uint8_t* src, size_t srcsize, uint8_t* dest, lzo_uint * puiDestSize)
{
...
bool LZOManager::Decompress(const uint8_t * src, size_t srcsize, uint8_t * dest, lzo_uint * puiDestSize)
{
