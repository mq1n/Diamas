...
namespace marriage
{
	...
	struct TMarriage
	{
		...
		TMarriage(uint32_t pid1, uint32_t pid2, int32_t _love_point, time_t _marry_time, const char* name1, const char* name2) : 
			m_pid1(pid1), 
			m_pid2(pid2), 
		...
		int32_t GetBonus(uint32_t dwItemVnum, bool bShare = true, LPCHARACTER me = nullptr);
